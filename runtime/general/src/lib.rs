...
/// We allow `Normal` extrinsics to fill up the block up to 90%, the rest can be
/// used by `Operational` extrinsics.
const NORMAL_DISPATCH_RATIO: Perbill = Perbill::from_percent(90);

/// We allow for 0.5 of a second of compute with a 12 second average block
/// time. We fix proof size at 50MiB.
const MAXIMUM_BLOCK_WEIGHT: Weight = Weight::from_parts(
    WEIGHT_REF_TIME_PER_SECOND.saturating_div(4).saturating_mul(2),
