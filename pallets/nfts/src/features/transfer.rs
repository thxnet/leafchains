...
impl<T: Config<I>, I: 'static> Pallet<T, I> {
    pub fn do_transfer(
        ...
        // The approved accounts have to be reset to None, because otherwise pre-approve
        // attack would be possible, where the owner can approve their second
        // account before making the transaction and then claiming the item
        // back.
