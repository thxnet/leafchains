...
pub mod pallet {
    ...
    impl<CollectionId: From<u16>, ItemId: From<u16>> BenchmarkHelper<CollectionId, ItemId> for () {
        fn collection(i: u16) -> CollectionId { i.into() }

        fn item(i: u16) -> ItemId { i.into() }
    }
    ...
    pub trait Config<I: 'static = ()>: frame_system::Config {
        ...
        /// The origin which may forcibly create or destroy an item or otherwise
        /// alter privileged attributes.
        type ForceOrigin: EnsureOrigin<Self::RuntimeOrigin>;

        /// Standard collection creation is only allowed if the origin
        /// attempting it and the collection are in this set.
        ...
        /// The basic amount of funds that must be reserved when adding an
        ...
        /// store in metadata, either "normal" metadata or attribute
        /// metadata.
        #[pallet::constant]
    ...
    /// The collection, if any, of which an account is willing to take
    /// ownership.
    #[pallet::storage]
    pub type OwnershipAcceptance<T: Config<I>, I: 'static = ()> =
        StorageMap<_, Blake2_128Concat, T::AccountId, T::CollectionId>;

    /// The items held by any given account; set out this way so that items
    ...
    /// The collections owned by any given account; set out this way so that
    /// collections owned by a single account can be enumerated.
    #[pallet::storage]
    ...
    /// Stores the `CollectionId` that is going to be used for the next
    /// collection. This gets incremented whenever a new collection is
    /// created.
    #[pallet::storage]
    ...
    pub enum Event<T: Config<I>, I: 'static = ()> {
        ...
        /// An approval for a `delegate` account to transfer the `item` of an
        /// item `collection` was cancelled by its `owner`.
        ApprovalCancelled {
            collection: T::CollectionId,
            item: T::ItemId,
            owner: T::AccountId,
        ...
        /// The deposit for a set of `item`s within a `collection` has been
        /// updated.
        ...
        /// A new attribute in the `Pallet` namespace was set for the
        /// `collection` or an `item` within that `collection`.
        PalletAttributeSet {
            collection: T::CollectionId,
    ...
    pub enum Error<T, I = ()> {
        ...
        AlreadyExists,
        /// The approval had a deadline that expired, so the approval isn't
        /// valid anymore.
        ApprovalExpired,
        /// The owner turned out to be different to what was expected.
        WrongOwner,
        /// The witness data given does not match the current state of the
        /// chain.
        BadWitness,
        ...
        WrongSetting,
        /// Item's config already exists and should be equal to the provided
        /// one.
    ...
    impl<T: Config<I>, I: 'static> Pallet<T, I> {
        ...
        ///
        /// This new collection has no items initially and its owner is the
        /// origin.
        ///
        ...
        ///
        /// Parameters:
        /// - `admin`: The admin of this collection. The admin is the initial
        ///   address of each
        ...
        /// Issue a new collection of non-fungible items from a privileged
        /// origin.
        ///
        ...
        ///   superuser permissions over this item, but may later change and
        ///   configure the permissions using `transfer_ownership` and
        ///   `set_team`.
        ///
        ...
        /// sender must be the owner of the `collection`.
        ///
        /// NOTE: The collection must have 0 items to be destroyed.
        ///
        /// - `collection`: The identifier of the collection to be destroyed.
        /// - `witness`: Information on the items minted in the collection. This
        ///   must be
        /// correct.
        ///
        ...
        /// - `witness_data`: When the mint type is `HolderOf(collection_id)`,
        ///   then the owned item_id from that collection needs to be provided
        ///   within the witness data object.
        ///
        /// Note: the deposit will be taken from the `origin` and not the
        /// `owner` of the `item`.
        ///
        ...
        ///
        /// The origin must conform to `ForceOrigin` or must be `Signed` and the
        /// sender must be the Issuer of the `collection`.
        ///
        /// - `collection`: The collection of the item to be minted.
        /// - `item`: An identifier of the new item.
        /// - `mint_to`: Account into which the item will be minted.
        ...
        ///
        /// The origin must conform to `ForceOrigin` or must be Signed and the
        /// signing account must be the owner of the `item`.
        ///
        ...
        /// - the approved delegate for the `item` (in this case, the approval
        ///   is reset).
        ///
        /// Arguments:
        ...
        /// - `items`: The items of the collection whose deposits will be
        ///   reevaluated.
        ///
        /// NOTE: This exists as a best-effort function. Any items which are
        /// unknown or in the case that the owner account does not have
        /// reservable funds to pay for a deposit increase are ignored.
        /// Generally the owner isn't going to call this on items
        /// whose existing deposit is less than the refreshed deposit as it
        /// would only cost them, so it's of little consequence.
        ///
        /// It will still return an error in the case that the collection is
        /// unknown or the signer is not permitted to call it.
        ///
        /// Weight: `O(items.len())`
        #[pallet::call_index(7)]
        ...
        ///
        /// Note: it's possible to only lock(set) the setting, but not to unset
        /// it.
        ///
        ...
        ///   `set_accept_ownership` with `collection` in order for this
        ...
        ///
        /// Origin must be either `ForceOrigin` or Signed and the sender should
        /// be the Owner of the `collection`.
        ///
        /// Note: by setting the role to `None` only the `ForceOrigin` will be
        /// able to change it after to `Some(account)`.
        ///
        ...
        /// Approve an item to be transferred by a delegated third-party
        /// account.
        ///
        /// Origin must be either `ForceOrigin` or Signed and the sender should
        /// be the Owner of the `item`.
        ///
        /// - `collection`: The collection of the item to be approved for
        ///   delegated transfer.
        /// - `item`: The item to be approved for delegated transfer.
        /// - `delegate`: The account to delegate permission to transfer the
        ///   item.
        ...
        ///   cancelled.
        /// - `item`: The item of the collection of whose approval will be
        ///   cancelled.
        ...
        ///
        /// Arguments:
        /// - `collection`: The collection of the item of whose approvals will
        ///   be cleared.
        /// - `item`: The item of the collection of whose approvals will be
        ///   cleared.
        ///
        ...
        ///
        /// Origin must be either `ForceOrigin` or Signed and the sender should
        /// be the Admin of the `collection`.
        ///
        /// - `collection`: The collection if the `item`.
        /// - `item`: An item to be locked.
        /// - `lock_metadata`: Specifies whether the metadata should be locked.
        /// - `lock_attributes`: Specifies whether the attributes in the
        ///   `CollectionOwner` namespace should be locked.
        ///
        /// Note: `lock_attributes` affects the attributes in the
        /// `CollectionOwner` namespace only. When the metadata or
        /// attributes are locked, it won't be possible the unlock them.
        ///
        ...
        /// - `CollectionOwner` namespace could be modified by the `collection`
        ///   Admin only;
        /// - `ItemOwner` namespace could be modified by the `maybe_item` owner
        ///   only. `maybe_item` should be set in that case;
        /// - `Account(AccountId)` namespace could be modified only when the
        ///   `origin` was given a permission to do so;
        ///
        /// The funds of `origin` are reserved according to the formula:
        /// `AttributeDepositBase + DepositPerByte * (key.len + value.len)`
        /// taking into account any already reserved funds.
        ///
        /// - `collection`: The identifier of the collection whose item's
        ///   metadata to set.
        ...
        /// Origin must be `ForceOrigin`.
        ///
        /// If the attribute already exists and it was set by another account,
        /// the deposit will be returned to the previous owner.
        ///
        ...
        /// Approve item's attributes to be changed by a delegated third-party
        /// account.
        ///
        ...
        /// - `delegate`: The account to delegate permission to change
        ...
        /// be the Admin of the `collection`.
        ///
        /// If the origin is Signed, then funds of signer are reserved according
        /// to the formula: `MetadataDepositBase + DepositPerByte *
        /// data.len` taking into account any already reserved funds.
        ///
        /// - `collection`: The identifier of the collection whose item's
        ///   metadata to set.
        ...
        ///
        /// Origin must be either `ForceOrigin` or `Signed` and the sender
        /// should be the Admin of the `collection`.
        ///
        /// If the origin is `Signed`, then funds of signer are reserved
        /// according to the formula: `MetadataDepositBase +
        /// DepositPerByte * data.len` taking into account any already
        /// reserved funds.
        ///
        ...
        /// Any deposit is freed for the collection's owner.
        ///
        /// - `collection`: The identifier of the collection whose metadata to
        ///   clear.
        ///
        ...
        ///
        /// Origin must be `Signed` and if `maybe_collection` is `Some`, then
        /// the signer must have a provider reference.
        ///
        /// - `maybe_collection`: The identifier of the collection whose
        ///   ownership the signer is willing to accept, or if `None`, an
        ///   indication that the signer is willing to accept no ownership
        ///   transferal.
        ///
        ...
        ///
        /// Origin must be either `ForceOrigin` or `Signed` and the sender
        /// should be the Owner of the `collection`.
        ///
        ...
        ///
        /// Origin must be either `ForceOrigin` or `Signed` and the sender
        /// should be the Issuer of the `collection`.
        ///
        /// - `collection`: The identifier of the collection to change.
        ...
        /// in exchange for `desired_item` from origin to target on the
        /// current blockchain. The target can execute the swap during
        /// the specified `duration` of blocks (if set). Additionally,
        /// the price could be set for the desired `item`.
        ///
        /// Origin must be Signed and must be an owner of the `item`.
        ///
        /// - `collection`: The collection of the item.
        ...
        /// - `maybe_price`: The price an owner is willing to pay or receive for
        ///   the desired `item`.
        /// - `duration`: A deadline for the swap. Specified by providing the
        ///   number of blocks
        ...
        ///
        /// Origin must be Signed.
        /// Origin must be an owner of the `item` if the deadline hasn't
        /// expired.
        ///
        /// - `collection`: The collection of the item.
        /// - `item`: The item an owner wants to give.
        ...
        /// This method executes a pending swap, that was created by a
        /// counterpart before.
        ///
        /// Origin must be Signed and must be an owner of the `item`.
        ///
        ...
        /// Origin must be Signed.
        ///
        /// - `mint_data`: The pre-signed approval that consists of the
        ///   information about the item, its metadata, attributes, who can mint
        ///   it (`None` for anyone) and until what block number.
        ...
        ///
        /// - `data`: The pre-signed approval that consists of the information
        ///   about the item, attributes to update and until what block number.
        /// - `signature`: The signature of the `data` object.
        /// - `signer`: The `data` object's signer. Should be an Admin of the
        ///   collection for the `CollectionOwner` namespace.
        ///
        /// Emits `AttributeSet` for each provided attribute.
        /// Emits `ItemAttributesApprovalAdded` if the approval wasn't set
        /// before. Emits `PreSignedAttributesSet` on success.
